            ...
            <div className='rounded-md bg-slate-800 p-3'>
                <div className='grid grid-cols-2 gap-3'>
                    <div>
                        ...
                        <p className='bg-green-600 p-1 text-center nt-2 rounded-sm'>{formatToUSD.format(totalIncome)}</p>
                    </div>
                    <div>
                        <p className='uppercase text-md font-bold text-center'>Total expense</p>
                        <p className='bg-red-500 p-1 text-center nt-2 rounded-sm'>{formatToUSD.format(totalExpense)}</p>
                    </div>
                </div>
